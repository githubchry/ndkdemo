...
//
#include "JNIDynamicRegisterDemo.h"
#include <string>
#include <android/log.h>

#define TAG "JNIDynamicRegisterDemo-cpp"
...
JNINativeMethod methods[] = {
        //第一个是java的方法名，第二个是参数，第三个是C层对应的函数
        {"Sayhello",                "()Ljava/lang/String;",                     (void *) Sayhello_a},
        {"Sayhello",                "(Ljava/lang/String;)Ljava/lang/String;",   (void *) Sayhello_b},
        {"add",                     "(II)I",                                    (void *) add},
        {"checkPwd",                "(Ljava/lang/String;)I",                    (void *) checkPwd},
        {"increaseArrayElse",       "([I)[I",                                   (void *) increaseArrayElse},
        {"callbackSub",             "()V",                                      (void *) callbackSub},
        {"callbackHelloFormJava",   "()V",                                      (void *) callbackHelloFormJava},
        {"callbackPrintString",     "()V",                                      (void *) callbackPrintString},
        {"callbackSayHello",        "()V",                                      (void *) callbackSayHello},
};
...
jint registerNativeMethod(JNIEnv *env) {
    jclass cl = env->FindClass("com/fsly/ndkdemo/JNIDynamicRegisterDemo");
...
/*使用之后结束线程时必须调用jvm->DetachCurrentThread()分离线程*/
JNIEnv* getJNIEnv(){
    JNIEnv* env = NULL;
...
/**
 * C回调java方法的核心思想：反射
 * 调用java中JNIDynamicRegisterDemo类中的public int sub(int x, int y)的方法
...
void callbackSub
    ...
    jclass jclazz = env->FindClass("com/fsly/ndkdemo/JNIDynamicRegisterDemo");
